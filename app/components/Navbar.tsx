...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute left-0 top-0 h-full flex items-center pl-8 select-none pointer-events-none"
      >
        <NavDigit
          ref={leftDigitRef}
          label="six"
      ...
      <div
        aria-hidden="true"
        className="absolute right-0 top-0 h-full flex items-center pr-8 select-none pointer-events-none"
      >
        <NavDigit
          ref={rightDigitRef}
          label="three"
